export const APP_MANIFESTS = [
  ...
  { id: 'focus', name: 'Focus', icon: 'F', category: 'Utility', windowType: 'immersive', supportsVirtual: true, supportsPassthrough: false, supportsMultitasking: false, preferredControls: ['head', 'pinch', 'touch'] },
  { id: 'environments', name: 'Environments', icon: 'E', category: 'Utility', windowType: 'immersive', supportsVirtual: true, supportsPassthrough: false, supportsMultitasking: false, preferredControls: ['head', 'pinch', 'touch'] },
